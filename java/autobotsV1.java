...
import autobots.util.InstanceOfMA30;
import autobots.util.Pair;

public class autobotsV1 {
...
//System.out.println("system time - server time : " + (System.currentTimeMillis() - serverTime));
			...
			// pair1).getPrice()));
			InstanceOfMA30 FLUXma30 = new InstanceOfMA30(pair2, pair1, client, isTestingMode, new ReadFile(0), 1);
...
//					case 1:
//// on vend normalement, et on achete sur la ma30
//						listOfStrategyCoeff.set(0, 0.5);
//						listOfStrategyCoeff.set(1, 0.5);
//						break;
//					case -1:
//// on achete normalement, et on vend sur la ma30
//						listOfStrategyCoeff.set(0, 0.5);
//						listOfStrategyCoeff.set(1, 0.5);
//						break;
//					default:
//						listOfStrategyCoeff.set(0, 1.0);
//						listOfStrategyCoeff.set(1, 0.0);
//						break;
//					}
//				} else {
//					strategy1Countdown += 0.084;
//				}
				if (isTestingMode) {
					Thread.sleep(100);
