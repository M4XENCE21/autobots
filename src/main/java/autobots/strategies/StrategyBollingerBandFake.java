...
public class StrategyBollingerBandFake extends Strategy {
	...
	public StrategyBollingerBandFake(BollingerBand bollingerBand, Connector connector, String pair1, String pair2) {
		super(bollingerBand);
...
//		this.timeStamp = time + (7 * 24 * 3600000); //1w
	...
	void run() {
		...
		// TODO pour le backtesting, il faut vérifier en plus si les ordres ont trigger,
		// a faire dans cette classe ou alors dans la class main avant l'appelle de la
		// methode run
